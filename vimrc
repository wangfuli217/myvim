...
augroup ccompile
    ...
    autocmd Filetype python nnoremap   <F5> <Esc>:w<CR>:term python  % <CR>
    ...
    autocmd Filetype javascript     nnoremap   <F5> <Esc>:w<CR>:term node  % <CR>
    autocmd Filetype vim    nnoremap   <F5> <Esc>:w<CR>:source % <CR>
augroup END

augroup crun
    autocmd Filetype c    nnoremap <leader><F5> <Esc>:w<CR>:vert term ./%< <CR>
    autocmd Filetype cpp  nnoremap <leader><F5> <Esc>:!g++ % -std=c++11 -g -o %< -pthread -lrt -lm -O1 <CR>:! ./%< <CR>
    autocmd Filetype python nnoremap <leader><F5> <Esc>:w<CR>:vert term python  % <CR>
    ...
    autocmd Filetype perl nnoremap <leader><F5> <Esc>:w<CR>:vert term perl % <CR>
    autocmd Filetype lua  nnoremap <leader><F5> <Esc>:w<CR>:vert term lua  % <CR>
    autocmd Filetype javascript   nnoremap <leader><F5> <Esc>:w<CR>:vert term node  % <CR>
...
" 静态代码扫描
augroup format
    nnoremap <F7> :SyntasticToggleMode<CR><CR>:!clang-tidy % -fix -fix-errors -header-filter=.* -checks="readability-braces-around-statements,misc-macro-parentheses" -- -I.<CR>
augroup END
...
let g:gutentags_project_root = ['.root', '.svn', '.git', '.project', '.built', '.configured_yyynyynnnn', '.gitignore', 'README', 'm4', 'configure', 'configure.ac', '.version', '.pc']
